...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\workspace\alura\study-python\flaskProject\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\workspace\alura\study-python\flaskProject\venv\Scripts\deactivate.nu'
